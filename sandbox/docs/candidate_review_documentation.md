...
1. **`documentation-reviewer-completeness`**: Audits what is NOT written: missing failure states, rollback voids, and blind spots.
2. **`documentation-reviewer-dialectic`**: Audits logical consistency, challenges confirmation bias, and exposes hidden trade-off costs.
3. **`documentation-reviewer-usability`**: Audits operational actionability, mistake-proofing, and high-stress runbook safety.
